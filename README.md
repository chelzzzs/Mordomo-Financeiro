...
O diferencial do projeto é a experiência do usuário "gamificada", guiada por uma persona (um mordomo animado). A interface fornece feedback visual imediato sobre a saúde financeira do usuário através de medidores de status, gráficos dinâmicos e as reações do personagem, tornando o controle de gastos mais engajador e menos tedioso.
...
* **HTML5** 
* **CSS3** (Flexbox, CSS Variables, Media Queries, Transições)
* **JavaScript (Lógica, Manipulação do DOM, Event Delegation, JSON parsing)
* **Chart.js** (Biblioteca externa para renderização do gráfico)
* **Web Storage API** 
